...
const OpportunityConceptNotePage = () => {
  ...
  return <PortalSidebar><div className="min-h-screen bg-[#fafafa] px-4 py-5 lg:px-8"><main className="mx-auto max-w-[1300px]">
    <button type="button" onClick={() => navigate(`/dashboard/portal/${portalId}/opportunities`)} className="mb-4 inline-flex cursor-pointer items-center gap-2 rounded-xl border border-orange-100 bg-white px-4 py-2.5 text-sm font-semibold text-orange-700 shadow-sm hover:bg-orange-50"><ArrowLeft size={17} /> Volver a oportunidades</button>
